...
module NWN {
  ...
  **/
  ...
  interface NWScript {
    ...
    void adjustAlignment(NWObject oSubject, int nAlignment, int nShift, bool bAllPartyMembers) throws NotInContextException;
    ...
    NWObject createTrapAtLocation(int nTrapType, NWLocation lLocation, double fSize, string sTag, StandardFaction tStandardFaction, string sOnDisarmScript, string sOnTrapTriggeredScript) throws NotInContextException;
    void createTrapOnObject(int nTrapType, NWObject oObject, StandardFaction tStandardFaction, string sOnDisarmScript, string sOnTrapTriggeredScript) throws NotInContextException;
    ...
    idempotent NWEffect effectACDecrease(int nValue, int nModifyType, int nDamageType) throws NotInContextException;
    idempotent NWEffect effectACIncrease(int nValue, int nModifyType, int nDamageType) throws NotInContextException;
    ...
    idempotent NWEffect effectConcealment(int nPercentage, int nMissType) throws NotInContextException;
    ...
    idempotent NWEffect effectDamage(int nDamageAmount, int nDamageType, int nDamagePower) throws NotInContextException;
    idempotent NWEffect effectDamageDecrease(int nPenalty, int nDamageType) throws NotInContextException;
    idempotent NWEffect effectDamageImmunityDecrease(int nDamageType, int nPercentImmunity) throws NotInContextException;
    idempotent NWEffect effectDamageImmunityIncrease(int nDamageType, int nPercentImmunity) throws NotInContextException;
    idempotent NWEffect effectDamageIncrease(int nBonus, int nDamageType) throws NotInContextException;
    idempotent NWEffect effectDamageReduction(int nAmount, int nDamagePower, int nLimit) throws NotInContextException;
    idempotent NWEffect effectDamageResistance(int nDamageType, int nAmount, int nLimit) throws NotInContextException;
    idempotent NWEffect effectDamageShield(int nDamageAmount, int nRandomAmount, int nDamageType) throws NotInContextException;
    ...
    idempotent NWEffect effectMissChance(int nPercentage, int nMissChanceType) throws NotInContextException;
    ...
    idempotent NWEffect effectSwarm(int nLooping, string sCreatureTemplate1, string sCreatureTemplate2, string sCreatureTemplate3, string sCreatureTemplate4) throws NotInContextException;
    ...
    idempotent int getAlignmentGoodEvil(NWObject oCreature) throws NotInContextException;
    idempotent int getAlignmentLawChaos(NWObject oCreature) throws NotInContextException;
    ...
    idempotent int getDamageDealtByType(int nDamageType) throws NotInContextException;
    ...
    idempotent NWItemProperty itemPropertyACBonusVsAlign(int nAlignGroup, int nACBonus) throws NotInContextException;
    idempotent NWItemProperty itemPropertyACBonusVsDmgType(int nDamageType, int nACBonus) throws NotInContextException;
    idempotent NWItemProperty itemPropertyACBonusVsRace(IPRacialType tIPRacialType, int nACBonus) throws NotInContextException;
    idempotent NWItemProperty itemPropertyACBonusVsSAlign(int nAlign, int nACBonus) throws NotInContextException;
    ...
    idempotent NWItemProperty itemPropertyAttackBonusVsAlign(int nAlignGroup, int nBonus) throws NotInContextException;
    ...
    idempotent NWItemProperty itemPropertyAttackBonusVsSAlign(int nAlignment, int nBonus) throws NotInContextException;
    ...
    idempotent NWItemProperty itemPropertyDamageBonus(int nDamageType, int nDamage) throws NotInContextException;
    idempotent NWItemProperty itemPropertyDamageBonusVsAlign(int nAlignGroup, int nDamageType, int nDamage) throws NotInContextException;
    idempotent NWItemProperty itemPropertyDamageBonusVsRace(IPRacialType tIPRacialType, int nDamageType, int nDamage) throws NotInContextException;
    idempotent NWItemProperty itemPropertyDamageBonusVsSAlign(int nAlign, int nDamageType, int nDamage) throws NotInContextException;
    idempotent NWItemProperty itemPropertyDamageImmunity(int nDamageType, int nImmuneBonus) throws NotInContextException;
    ...
    idempotent NWItemProperty itemPropertyDamageResistance(int nDamageType, int nHPResist) throws NotInContextException;
    idempotent NWItemProperty itemPropertyDamageVulnerability(int nDamageType, int nVulnerability) throws NotInContextException;
    ...
    idempotent NWItemProperty itemPropertyEnhancementBonusVsAlign(int nAlignGroup, int nBonus) throws NotInContextException;
    ...
    idempotent NWItemProperty itemPropertyEnhancementBonusVsSAlign(int nAlign, int nBonus) throws NotInContextException;
    idempotent NWItemProperty itemPropertyEnhancementPenalty(int nPenalty) throws NotInContextException;
    idempotent NWItemProperty itemPropertyExtraMeleeDamageType(int nDamageType) throws NotInContextException;
    idempotent NWItemProperty itemPropertyExtraRangeDamageType(int nDamageType) throws NotInContextException;
    ...
    idempotent NWItemProperty itemPropertyLimitUseByAlign(int nAlignGroup) throws NotInContextException;
    ...
    idempotent NWItemProperty itemPropertyLimitUseBySAlign(int nAlignment) throws NotInContextException;
    ...
    idempotent NWItemProperty itemPropertyTrap(int nTrapLevel, int nTrapType) throws NotInContextException;
